...
import newLink from 'ory-editor-plugins-newLink'
...
const slate = slateFactory([...defaultSlatePlugins, new KatexPlugin({ P }), new newLink()])
// Define which plugins we want to use. We only have slate and parallax available, so load those.
const plugins = {
  content: [slate, spacer, image, video, divider, geogebra], // Define plugins for content cells
